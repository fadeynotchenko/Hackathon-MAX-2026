...
{{seller_name}} (ИНН {{seller_inn}}), именуемое «Исполнитель», в лице
{{seller_director}}, и {{client_name}} (ИНН {{client_inn}}), именуемое
«Заказчик», в лице {{client_director}}, заключили настоящий договор.
...
2.2. Заказчик оплачивает услуги в течение {{payment_days}} дней с момента
подписания акта.

3. Срок
3.1. Исполнитель оказывает услуги в течение {{term_days}} дней с даты
подписания договора.
...
______________________ / {{seller_director}} /
______________________ / {{client_director}} /
""",
)
